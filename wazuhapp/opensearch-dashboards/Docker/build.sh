...
# Repositories URLs
wazuh_app_clone_repo_url="https://github.com/duplocloud/wazuh-dashboard-plugins.git"
wazuh_app_raw_repo_url="https://raw.githubusercontent.com/duplocloud/wazuh-dashboard-plugins"
